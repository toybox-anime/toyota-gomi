...
// 類義語・別名（クライアント側スマート検索用。API不要で"言い換え"に強くする）
const SYNONYMS = {
  "ペットボトル":["ペット","ボトル","pet","ぺっとぼとる"],
  "レジ袋":["ビニール袋","ビニールぶくろ","ふくろ","バッグ","bag"],
  "乾電池":["電池","バッテリー","でんち","battery"],
  "蛍光管・蛍光灯":["蛍光灯","蛍光管","けいこうとう","tube"],
  "電球（白熱・LED）":["電球","ライト","LED","でんきゅう","bulb"],
  "使い捨てライター":["チャッカマン","ライター","らいたー","lighter"],
  "スプレー缶":["スプレー","制汗スプレー","殺虫スプレー","spray"],
  "カセットボンベ":["ガスボンベ","カセットガス","ボンベ"],
  "紙おむつ":["おむつ","オムツ","diaper","fralda"],
  "傘（金属骨）":["かさ","カサ","傘","umbrella","guarda-chuva"],
  "なべ・フライパン":["鍋","フライパン","なべ","pan","panela"],
  "陶磁器・茶碗・皿":["茶碗","皿","食器","陶器","瀬戸物","dish","plate"],
  "ガラスコップ":["コップ","グラス","cup","glass"],
  "鏡":["ミラー","mirror","espelho"],
  "テレビ":["TV","tv","液晶","モニター","television"],
  "パソコン":["PC","pc","ノートパソコン","ラップトップ","laptop","computador"],
  "冷蔵庫・冷凍庫":["冷蔵庫","冷凍庫","れいぞうこ","fridge","geladeira"],
  "洗濯機・衣類乾燥機":["洗濯機","乾燥機","せんたくき","washer"],
  "自転車":["チャリ","じてんしゃ","bike","bicycle","bicicleta"],
  "食用油（紙・布に吸わせる）":["油","てんぷら油","サラダ油","oil","óleo"],
  "生ごみ":["残飯","食べ残し","なまごみ","garbage","food"],
  "段ボール":["ダンボール","だんぼーる","cardboard","box","papelão"],
  "新聞・チラシ":["新聞","チラシ","newspaper","jornal"],
  "雑誌・本":["雑誌","本","マンガ","magazine","book"],
  "古着・古布":["古着","服","衣類","洋服","clothes","roupa"],
  "布団・マットレス":["布団","ふとん","マットレス","futon","colchão"],
  "家具（タンス・机）":["家具","タンス","机","椅子","いす","furniture","móvel"],
};
