...
// ===== 多言語辞書 =====
const I18N = {
  ja:   { vList:"リスト", vMonth:"月で見る", prevM:"前の月", nextM:"次の月", nextDay:"次のごみの日", after:"そのあと", dayAfter:"あさって", inDays:"あと{n}日", timeShort:"朝8:30まで", todayDone:"今日の{c}は朝8:30まででした", privacy:"使い方の改善のため、匿名の利用件数（検索された品目など）を集計しています。個人や端末を特定する情報は送りません。", label:"日本語", appName:"ごみ収集日ガイド", search:"🔍 自治区・町名で検索", all:"全%d自治区", hit:"該当 %d 件",
